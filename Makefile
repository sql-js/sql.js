...
js/sql-raw.js: c/sqlite3.bc js/pre.js js/post.js
	$(EMCC) -s ASM_JS=1 $(CFLAGS) c/sqlite3.bc --pre-js js/pre.js --post-js js/post.js -o js/sql-raw.js -s EXPORTED_FUNCTIONS=$(EXPORTED_FUNCTIONS)
...
js/sql-api-raw.js: c/sqlite3.bc js/api.js
	$(EMSCRIPTEN)/emcc -s RESERVED_FUNCTION_POINTERS=2 $(CFLAGS) c/sqlite3.bc --post-js js/api.js -o js/sql-api-raw.js -s EXPORTED_FUNCTIONS=$(EXPORTED_FUNCTIONS)
