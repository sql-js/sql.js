...
Database = (function() {
  function Database(data, initialDbSize) {
    ...
    if (initialDbSize != null) {
      this.run('VACUUM');
      parent = FS.lookupPath('/');
      parentNode = parent.node;
      dbNode = FS.lookupNode(parentNode, this.filename);
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=60176;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 60224, 4), 60224);
