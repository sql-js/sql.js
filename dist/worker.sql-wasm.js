...
e.onRuntimeInitialized=function(){function a(h,l){this.Pa=h;this.db=l;this.Oa=1;this.gb=[]}function b(h){this.filename="dbfile_"+(4294967295*Math.random()>>>0);if(null!=h){var l=this.filename,p=l?k("//"+l):"/";l=aa(!0,!0);p=ba(p,(void 0!==l?l:438)&4095|32768,0);if(h){if("string"===typeof h){for(var r=Array(h.length),A=0,da=h.length;A<da;++A)r[A]=h.charCodeAt(A);h=r}ca(p,l|146);r=m(p,"w");fa(r,h,0,h.length,0,void 0);ja(r);ca(p,l)}}this.handleError(f(this.filename,c));this.db=q(c,"i32");mc(this.db);
...
this.Oa,this.Oa+=1);return tc(this.Pa,h)};a.prototype.Cb=function(h){null==h&&(h=this.Oa,this.Oa+=1);return uc(this.Pa,h)};a.prototype.getBlob=function(h){null==h&&(h=this.Oa,this.Oa+=1);var l=wc(this.Pa,h);h=vc(this.Pa,h);for(var p=new Uint8Array(l),r=0;r<l;r+=1)p[r]=x[h+r];return p};a.prototype.get=function(h){null!=h&&this.bind(h)&&this.step();h=[];for(var l=sc(this.Pa),p=0;p<l;p+=1)switch(xc(this.Pa,p)){case 1:case 2:h.push(this.Bb(p));break;case 3:h.push(this.Cb(p));break;case 4:h.push(this.getBlob(p));
break;default:h.push(null)}return h};a.prototype.getColumnNames=function(){for(var h=[],l=rc(this.Pa),p=0;p<l;p+=1)h.push(yc(this.Pa,p));return h};a.prototype.getAsObject=function(h){h=this.get(h);for(var l=this.getColumnNames(),p={},r=0;r<l.length;r+=1)p[l[r]]=h[r];return p};a.prototype.run=function(h){null!=h&&this.bind(h);this.step();return this.reset()};a.prototype.yb=function(h,l){null==l&&(l=this.Oa,this.Oa+=1);h=ka(h);var p=la(h);this.gb.push(p);this.db.handleError(B(this.Pa,l,p,h.length-1,
0))};a.prototype.tb=function(h,l){null==l&&(l=this.Oa,this.Oa+=1);var p=la(h);this.gb.push(p);this.db.handleError(H(this.Pa,l,p,h.length,0))};a.prototype.xb=function(h,l){null==l&&(l=this.Oa,this.Oa+=1);this.db.handleError((h===(h|0)?nc:ea)(this.Pa,l,h))};a.prototype.wb=function(h){null==h&&(h=this.Oa,this.Oa+=1);H(this.Pa,h,0,0,0)};a.prototype.mb=function(h,l){null==l&&(l=this.Oa,this.Oa+=1);switch(typeof h){case "string":this.yb(h,l);return;case "number":case "boolean":this.xb(h+0,l);return;case "object":if(null===
h){this.wb(l);return}if(null!=h.length){this.tb(h,l);return}}throw"Wrong API use : tried to bind a value of an unknown type ("+h+").";};a.prototype.vb=function(h){var l=this;Object.keys(h).forEach(function(p){var r=oc(l.Pa,p);0!==r&&l.mb(h[p],r)});return!0};a.prototype.ub=function(h){for(var l=0;l<h.length;l+=1)this.mb(h[l],l+1);return!0};a.prototype.reset=function(){return 0===Ac(this.Pa)&&0===zc(this.Pa)};a.prototype.freemem=function(){for(var h;void 0!==(h=this.gb.pop());)ma(h)};a.prototype.free=
function(){var h=0===Bc(this.Pa);delete this.db.eb[this.Pa];this.Pa=0;return h};b.prototype.run=function(h,l){if(!this.db)throw"Database closed";if(l){h=this.prepare(h,l);try{h.step()}finally{h.free()}}else this.handleError(n(this.db,h,0,0,c));return this};b.prototype.exec=function(h,l){if(!this.db)throw"Database closed";var p=na(),r=null;try{var A=oa(h)+1,da=u(A);pa(h,x,da,A);var D=da;var ha=u(4);for(h=[];0!==q(D,"i8");){qa(c);qa(ha);this.handleError(v(this.db,D,-1,c,ha));var ia=q(c,"i32");D=q(ha,
"i32");if(0!==ia){A=null;r=new a(ia,this);for(null!=l&&r.bind(l);r.step();)null===A&&(A={columns:r.getColumnNames(),values:[]},h.push(A)),A.values.push(r.get());r.free()}}return h}catch(E){throw r&&r.free(),E;}finally{ra(p)}};b.prototype.each=function(h,l,p,r){"function"===typeof l&&(r=p,p=l,l=void 0);h=this.prepare(h,l);try{for(;h.step();)p(h.getAsObject())}finally{h.free()}if("function"===typeof r)return r()};b.prototype.prepare=function(h,l){qa(c);this.handleError(w(this.db,h,-1,c,0));h=q(c,"i32");
if(0===h)throw"Nothing to prepare";var p=new a(h,this);null!=l&&p.bind(l);return this.eb[h]=p};b.prototype["export"]=function(){Object.values(this.eb).forEach(function(l){l.free()});Object.values(this.Va).forEach(sa);this.Va={};this.handleError(g(this.db));var h=ta(this.filename);this.handleError(f(this.filename,c));this.db=q(c,"i32");return h};b.prototype.close=function(){null!==this.db&&(Object.values(this.eb).forEach(function(h){h.free()}),Object.values(this.Va).forEach(sa),this.Va={},this.handleError(g(this.db)),
ua("/"+this.filename),this.db=null)};b.prototype.handleError=function(h){if(0===h)return null;h=qc(this.db);throw Error(h);};b.prototype.getRowsModified=function(){return t(this.db)};b.prototype.create_function=function(h,l){Object.prototype.hasOwnProperty.call(this.Va,h)&&(va(this.Va[h]),delete this.Va[h]);var p=wa(function(r,A,da){for(var D,ha=[],ia=0;ia<A;ia+=1){var E=q(da+4*ia,"i32"),P=Dc(E);if(1===P||2===P)E=Hc(E);else if(3===P)E=Fc(E);else if(4===P){P=E;E=Ec(P);P=Gc(P);for(var vb=new Uint8Array(E),
Ca=0;Ca<E;Ca+=1)vb[Ca]=x[P+Ca];E=vb}else E=null;ha.push(E)}try{D=l.apply(null,ha)}catch(Oc){qb(r,Oc,-1);return}switch(typeof D){case "boolean":Lc(r,D?1:0);break;case "number":Ic(r,D);break;case "string":Jc(r,D,-1,-1);break;case "object":null===D?pb(r):null!=D.length?(A=la(D),Kc(r,A,D.length,-1),ma(A)):qb(r,"Wrong API use : tried to return a value of an unknown type ("+D+").",-1);break;default:pb(r)}});this.Va[h]=p;this.handleError(Cc(this.db,h,l.length,1,0,p,0,0,0));return this};e.Database=b};
var xa={},y;for(y in e)e.hasOwnProperty(y)&&(xa[y]=e[y]);var ya="./this.program",za=!1,z=!1,Aa=!1,Ba=!1;za="object"===typeof window;z="function"===typeof importScripts;Aa="object"===typeof process&&"object"===typeof process.versions&&"string"===typeof process.versions.node;Ba=!za&&!Aa&&!z;var C="",Da,Ea,Fa,Ga;
...
L:function(a){var b=Date.now()/1E3|0;a&&(J[a>>2]=b);return b},s:function(a,b){if(b){var c=1E3*J[b+8>>2];c+=J[b+12>>2]/1E3}else c=Date.now();a=O(a);try{b=c;var d=W(a,{Wa:!0}).node;d.La.Ra(d,{timestamp:Math.max(b,c)});return 0}catch(f){a=f;if(!(a instanceof Q)){a+=" : ";a:{d=Error();if(!d.stack){try{throw Error();}catch(g){d=g}if(!d.stack){d="(no stack trace available)";break a}}d=d.stack.toString()}e.extraStackTrace&&(d+="\n"+e.extraStackTrace());d=ob(d);throw a+d;}Ab(a.Na);return-1}}};
